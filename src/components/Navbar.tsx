        ...
        >
            <div className="container-wide px-6 py-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <motion.button
                        onClick={toggleTheme}
                        className="w-10 h-10 flex items-center justify-center rounded-full glass-card hover:bg-light-primary/10 dark:hover:bg-dark-primary/10 transition-colors relative group border border-light-text/10 dark:border-dark-text/10 after:absolute after:-inset-4 after:content-['']"
                        whileHover={{ scale: 1.1, rotate: 180 }}
                        whileTap={{ scale: 0.9 }}
                        aria-label="Toggle Theme"
                    >
                        <div className="absolute inset-0 rounded-full bg-light-primary/20 dark:bg-dark-primary/20 scale-0 group-hover:scale-100 transition-transform duration-300" />
