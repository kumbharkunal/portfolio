...
const ProjectCard = memo(({ title, description, tech, image, github, live, index }: ProjectCardProps) => {
    return (
        <motion.div
        ...
        >
            <Tilt
                ...
                glareEnable={false}
            >
                <div className="glass-card p-6 h-full hover:shadow-2xl transition-shadow duration-300">
                    <div className="relative overflow-hidden rounded-xl mb-6 h-48 group">
                        <img
                            src={image}
                            alt={title}
                    ...
                    <h3 className="text-2xl font-sora font-bold mb-3 gradient-text">
                        {title}
                    </h3>
